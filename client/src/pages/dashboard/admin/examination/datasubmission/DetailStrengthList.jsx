...
import generateDetailStrengthReportHtml from "../Reports/DetailStrengthReport";

const sampleData = [
  { ExamDate: "09-Sep-2024", Session: "FN", CNO: "1020", Regl: "M", Sem: "VI", ColNo: "1", SubjectName: "INDUSTRIAL ENGINEERING AND MANAGEMENT", Candidate: 3 },
  { ExamDate: "12-Sep-2025", Session: "FN", CNO: "1020", Regl: "R20", Sem: "II", ColNo: "2", SubjectName: "BASICS OF MECHANICAL ENGINEERING", Candidate: 8 },
  { ExamDate: "12-Sep-2025", Session: "AN", CNO: "1030", Regl: "N", Sem: "IV", ColNo: "4", SubjectName: "E-Vehicle Technology and Policy", Candidate: 12 },
];

const DetailStrengthList = () => {
  const [data, setData] = useState(sampleData);
  const [loading, setLoading] = useState({ close: false });
  const [previewHtml, setPreviewHtml] = useState("");

  useEffect(() => {
    setPreviewHtml(generateDetailStrengthReportHtml(data));
  }, [data]);
      ...
      <div className="dashboard-main">
        ...
        <div className="dashboard-main-body">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
            <h6 className="fw-semibold mb-0">Detail Strength List</h6>
          </div>
...
export default DetailStrengthList;
